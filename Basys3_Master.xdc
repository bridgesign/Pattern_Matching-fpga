...
#set_property PACKAGE_PIN P1 [get_ports sig]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports signal]
set_property IOSTANDARD LVCMOS33 [get_ports signal]
#set_property PACKAGE_PIN E19 [get_ports led_display[1]]
#set_property IOSTANDARD LVCMOS33 [get_ports led_display[1]]
set_property PACKAGE_PIN U19 [get_ports state[0]]
...
set_property PACKAGE_PIN W18 [get_ports state[2]]
set_property IOSTANDARD LVCMOS33 [get_ports state[2]]
#set_property PACKAGE_PIN U15 [get_ports led_display[5]]
#set_property IOSTANDARD LVCMOS33 [get_ports led_display[5]]
set_property PACKAGE_PIN U14 [get_ports counter[0]]
set_property IOSTANDARD LVCMOS33 [get_ports counter[0]]
set_property PACKAGE_PIN V14 [get_ports counter[1]]
set_property IOSTANDARD LVCMOS33 [get_ports counter[1]]
set_property PACKAGE_PIN V13 [get_ports counter[2]]
set_property IOSTANDARD LVCMOS33 [get_ports counter[2]]
set_property PACKAGE_PIN V3 [get_ports counter[3]]
set_property IOSTANDARD LVCMOS33 [get_ports counter[3]]
set_property PACKAGE_PIN W3 [get_ports counter[4]]
set_property IOSTANDARD LVCMOS33 [get_ports counter[4]]
set_property PACKAGE_PIN U3 [get_ports counter[5]]
...
set_property PACKAGE_PIN N3 [get_ports counter[7]]
set_property IOSTANDARD LVCMOS33 [get_ports counter[7]]
set_property PACKAGE_PIN P1 [get_ports counter[8]]
set_property IOSTANDARD LVCMOS33 [get_ports counter[8]]
set_property PACKAGE_PIN L1 [get_ports counter[9]]
